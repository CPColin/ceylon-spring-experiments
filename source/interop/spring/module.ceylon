...
module interop.spring "1.0.0" {
    ...
    shared import maven:org.springframework.data:"spring-data-commons" "2.0.10.RELEASE";
    shared import maven:org.springframework.data:"spring-data-jpa" "2.0.10.RELEASE";
    shared import maven:org.springframework:"spring-tx" "5.0.9.RELEASE";
